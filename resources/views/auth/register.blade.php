<x-main>
    <section class="vh-100" style="background-color: #d1d1de;">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form action="{{route('register')}}" method="POST" class="mx-1 mx-md-4">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                <input type="password" id="form3Example4cd" class="form-control" name="password_confirmation"value="{{old('password_confirmation')}}" />
